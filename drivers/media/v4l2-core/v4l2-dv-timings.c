 ...
 */
bool v4l2_detect_cvt2(unsigned frame_height,
		     unsigned hfreq,
		     unsigned vsync,
...
EXPORT_SYMBOL_GPL(v4l2_detect_cvt2);
 ...
 */
bool v4l2_detect_gtf2(unsigned frame_height,
		unsigned hfreq,
		unsigned vsync,
		u32 polarities,
		bool interlaced,
...
EXPORT_SYMBOL_GPL(v4l2_detect_gtf2);
